<div class="box-body" style="color: #505050;padding:0px;min-height: 0px;line-height: 2;">
    <form id="charge-fast" action="{{ asset('user/do-charge') }}" method="POST">
        ...
        <div class="form-group">
            <input class="form-control c-square c-theme" type="text" id="serial" name="serial" placeholder="Nhập số serial">
        </div>
        <div class="form-group">
            <input class="form-control c-square c-theme" type="text" id="pin" name="pin" placeholder="Nhập mã thẻ">
        </div>
        <div class="form-group">
            ...
            $('#charge-fast').validate({
                ...
                messages: {
                    ...
                    serial: {
                        ...
                        minlength: 'Số serial phải từ 6 đến 18 ký tự',
                        maxlength: 'Số serial phải từ 6 đến 18 ký tự',
                    },
                    pin: {
                        required: 'Mã số thẻ chưa được nhập.',
                        minlength: 'Mã số thẻ phải từ 6 đến 18 ký tự',
                        maxlength: 'Mã số thẻ phải từ 6 đến 18 ký tự',
                    },
                },
