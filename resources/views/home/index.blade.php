                    ...
                    <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
                        <!-- Begin: Title 1 component -->
                         <div class="c-content-title-1">
                            <h3 class="c-center c-font-uppercase c-font-bold">Free Fire</h3>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="view">
                                                        ...
                                                        <a href="{{ asset('vong-quay-tien/'.$spin->id) }}" title="{{ isset($spin->title) ? $spin->title : 'Vòng quay' }}"><strong>Chơi Ngay</strong></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
										...
										<div class="example2">{{ $slotMachine->price }}đ											
                                            ...
                                            <div class="a-more">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="view">
                                                            <a href="{{ asset('slot-machine/'.$slotMachine->url) }}" title="{{ $slotMachine->title }}"><strong>Chơi Ngay</strong></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="example2">{{ $flipCard->price }}đ												
                                            ...
                                            <div class="a-more">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="view">
                                                            <a href="{{ asset('flip-card/'.$flipCard->url) }}" title="{{ $flipCard->title }}"><strong>Chơi Ngay</strong></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
